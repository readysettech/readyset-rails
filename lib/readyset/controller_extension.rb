module Readyset
  ...
  module ControllerExtension
    ...
    included do
      ...
      #
      # This method defines an around_action callback that wraps the given actions. Inside the callback,
      # it switches the ActiveRecord connection to a replica database, ensuring that all database queries
      ...
      # @param options [Hash] Additional options to refine the callback application, such as :only or :except.
      # @param block [Proc] An optional block that can be used for additional logic around the action execution.
      #
      # @example
